...
<body>
<div class="wrapper">
	<div class="left-section"><img src="images/logo.jpeg"/></div>
	<div class="right-section">
		<h1 id="logo">THRIFTBAY.CO</h1>
		...
		<ul class="social">
			<li id="instagram"><a href="https://instagram.com/thriftbay.co?igshid=ceuu0mkr8m0a"><i class="fa fa-instagram"></i></a></li>
		...
		<ul class="info">
			<!--li><i class="fa fa-phone-square"></i>981-981-9811</li>
			<li><i class="fa fa-map-marker"></i>301 Clematis. Suite 3000, West Palm Beach, FL 33401</li-->
			<li id="email"></i><a href="mailto:thriftbay@gmail.com"><i class="fa fa-envelope"></i>thriftbay@gmail.com</a></li>
		</ul>
	...
	<div class="watch-section"><img src="images/logo.jpeg"/></div>
</div>
